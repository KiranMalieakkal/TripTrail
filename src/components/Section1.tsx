  ...
  return (
    <>
      <div className="flex flex-col h-screen">
        <div className="flex-grow flex gap-2 flex-col overflow-y-auto mb-2">
          {cards}
        </div>
        <div className="py-2 text-center w-1/2 self-center bg-white">
          <button
            className="bg-blue-500 text-white px-4 py-2 rounded mb-20"
            onClick={handleClick}
          >
            Add
          </button>
